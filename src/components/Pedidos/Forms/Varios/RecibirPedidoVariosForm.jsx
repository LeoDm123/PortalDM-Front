...
const RecibirPedidoVariosForm = ({
  ...
  const fetchMaterialData = async () => {
    try {
      const resp = await serverAPI.get(
        `/pedidoVarios/obtenerMaterialPorCodigo/${pedidoId}/${codigoMat}`
      );
  ...
  const fetchPedidoData = async () => {
    try {
      const resp = await serverAPI.get(
        `/pedidoVarios/obtenerPedidoPorId/${pedidoId}`
      );
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await serverAPI.put(
        `/pedidoVarios/recibirPedido/${pedidoId}/${codigoMat}`,
        {
          CantRecibida,
          FechaRecep,
          nroPedido,
...
export default RecibirPedidoVariosForm;
